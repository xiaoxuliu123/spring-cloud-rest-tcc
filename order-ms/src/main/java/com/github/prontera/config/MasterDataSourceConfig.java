...
@MapperScan(basePackages = MasterDataSourceConfig.PACKAGE, annotationClass = MyBatisRepository.class, sqlSessionFactoryRef = "masterSqlSessionFactory")
public class MasterDataSourceConfig {

    // 精确到 master 目录，以便跟其他数据源隔离
    static final String PACKAGE = "com.github.prontera.persistence";
